...
export const MemoryProfileSchema = z.object({
	...
	description: z.string().default('Default memory profile for general programming knowledge and decision retention.'),
	prompts: z.object({
		system: z.string()
	}),
	tools: z.record(
	...
	extractablePatterns: z.array(z.object({
		pattern: z.string(),
		flags: z.string().optional(),
	})),
	tagMap: z.record(z.string())
});
